...
def preprocess():
    ...
    preprocessing_path = "/preprocess_data.npy"
    ...
    adjusted_dataset, return_values, loaded_tokenizer = post_get_data()

    return adjusted_dataset, return_values, loaded_tokenizer
